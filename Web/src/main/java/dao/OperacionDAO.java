...
public class OperacionDAO {
    ...
    public static void insertarOperacion(Operacion pOperacion, LocalDate pFecha) throws ClassNotFoundException
    {
    ...
    public static void asignarOperacionCuenta(Operacion pOperacion, String pNumCuenta) throws ClassNotFoundException
    {
        int id = pOperacion.getId();
    ...
    public static int cantOperacionesBD() throws ClassNotFoundException{
        ConexionBase con = new ConexionBase();
        con.obtenerConexion();
        ResultSet resultado;
        int contador = 1;
    ...
    public static ArrayList<Operacion> getOperacionesBD() throws ClassNotFoundException{
    ...
    public static ArrayList<Operacion> getOperacionesCuenta(String numCuenta) throws ClassNotFoundException{
        operaciones = new ArrayList<>();
