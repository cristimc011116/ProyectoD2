...
public class PersonaDAO {
    ...
    public static boolean estaRegistrada(int idPersona) throws ClassNotFoundException{
        int contador = 0;
        ...
        public static void insertarCliente(Persona pCliente) throws ClassNotFoundException
    {
    ...
    public static Persona obtenerPersona(int id) throws ClassNotFoundException{
        ConexionBase con = new ConexionBase();
        con.obtenerConexion();
    ...
    public static ArrayList<Persona> getPersonasBD() throws ClassNotFoundException{
    ...
    public static int contadorPersonasBD() throws ClassNotFoundException{
    ...
    public static ResultSet recuperarTodosLosUsuariosBD() throws ClassNotFoundException{
        ConexionBase con = new ConexionBase();
        con.obtenerConexion();
