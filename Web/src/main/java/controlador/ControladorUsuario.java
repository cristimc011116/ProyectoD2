...
public class ControladorUsuario implements ActionListener{
    ...
    public ControladorUsuario(Menu pMenu) throws ClassNotFoundException
    {
        this.menu = pMenu;
        this.latabla = null;
        this.latabla2 = null;
    ...
    public void depositar() throws ClassNotFoundException   
    {
    ...
    public void consultarStatus() throws ClassNotFoundException   
    {
    ...
    public void listarCuentas() throws ClassNotFoundException{
    ...
    public void consultarGananciaBancoCuenta() throws ClassNotFoundException
    {
    ...
    public void LlenarTablaConsultaBancoPorCuenta(String cuenta) throws ClassNotFoundException
    {
    ...
    public void consultarGananciaBancoTotalizado() throws ClassNotFoundException
    {
      double sumaComisiones = 0;
      double sumaRetiros =0;
      double sumaDepositos =0;
    ...
    public double LlenarTablaConsultaBancoTotalizado() throws ClassNotFoundException
    {
      double sumaComi=0;
      String[] titulos = {
      "Detalle de la operación",
    ...
    public void consultarInfoCuenta() throws ClassNotFoundException{
    ...
    public int validarMonto(double pMonto, String pNumCuenta, String moneda) throws ClassNotFoundException
    {
    ...
    public int validarEntrId(String strId) throws ClassNotFoundException
    {
    ...
    public int validarId(String id) throws ClassNotFoundException{
    ...
    public static boolean auxIdP1(String strid) throws ClassNotFoundException{
    ...
    public static boolean auxIdP2(int id) throws ClassNotFoundException{
      boolean esNum = false;
    ...
    public static boolean auxNumCuentaP1(String strNumCuenta) throws ClassNotFoundException{
      boolean esCorrecto = false;
    ...
    public static boolean auxNumCuentaP2(String pNumCuenta) throws ClassNotFoundException{
      boolean esNum = false;
      Cuenta cuenta = CuentaDAO.obtenerCuenta(pNumCuenta);
    ...
    public void cargarDatosPersonas() throws ClassNotFoundException{
    ...
    public void cargarDatosCuentas() throws ClassNotFoundException{
    ...
    public static String recuperarUsuario(String idUsuario) throws ClassNotFoundException
    {
      ...
      return total;
        ...
        public static String recuperarCuenta(String pNumeroCuenta) throws ClassNotFoundException
    {
    ...
    public static double aplicaComision(String numCuenta, double monto) throws ClassNotFoundException
   {
   ...
   public static double aplicaComisionRetiro(String numCuenta, double monto, int numero) throws ClassNotFoundException
   {
       int contador = CuentaDAO.contadorOperacionesCuenta(numCuenta);
       if (contador > numero)
       {
    ...
    public static String imprimirCuenta(String pNum) throws ClassNotFoundException{
    ...
    public static String imprimirPersona(int id) throws ClassNotFoundException{
      Persona persona = PersonaDAO.obtenerPersona(id);
