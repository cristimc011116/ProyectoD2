 ...
 */
@WebServlet(name = "estadoCuenta", urlPatterns = {"/estadoCuenta"})
public class EstadoCuenta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Consultar estado de cuenta</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 align=\"center\">Proceda a consultar el estado de su cuenta</h1>");
            out.println("<br>");
            out.println("<br>");
            out.println("<div align=\"center\">Complete los datos</div>");
            out.println("<br>");
            out.println("<form action=\"respEstado\" method=\"post\">");
