...
public class ConsultaRegistrosCLI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String Bitacoras = imprimirArchivosTXT(nombre) + imprimirArchivosXML(nombre) + imprimirArchivosCSV(nombre);
           ...
           try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Consultas de las operaciones realizadas en CLI</title>");            
            out.println("</head>");
            out.println("<body>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ConsultaRegistrosCLI.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
