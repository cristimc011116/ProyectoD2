 ...
 */
@WebServlet(name = "respGanancia", urlPatterns = {"/respGanancia"})
public class RespGanancia extends HttpServlet {
    /**
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RespGanancia.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
