 ...
 */
@WebServlet(name = "gananciaComisionTotal", urlPatterns = {"/gananciaComisionTotal"})
public class GananciaComisionTotal extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Consulta de ganancia banco totalizado</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 align=\"center\">Consulta de ganancia de banco por comisiones totalizado</h1>");
            out.println("<br>");
            out.println("<br>");
            out.println("<br>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GananciaComisionTotal.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
