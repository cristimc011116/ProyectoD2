 ...
 */
@WebServlet(name = "cambiarPin", urlPatterns = {"/cambiarPin"})
public class CambiarPin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 align=\"center\">Proceda a cambiar su pin</h1>");
            out.println("<br>");
            out.println("<br>");
            out.println("<div align=\"center\">Complete los datos</div>");
            out.println("<br>");
            out.println("<form action=\"respCambioPin\" method=\"post\">");
            ...
            out.println("</tr>");
            out.println("<tr>");
            out.println("<td colspan=\"2\" align=\"center\"><input type=\"submit\" value=\"cambiar\"/></td>");
            out.println("</tr>");
            out.println("</table>");
            out.println("</form>");
            out.println("</body>");
