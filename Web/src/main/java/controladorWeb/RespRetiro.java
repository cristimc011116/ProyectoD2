 ...
 */
@WebServlet(name = "respRetiro", urlPatterns = {"/respRetiro"})
public class RespRetiro extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Retiro</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<br>");
            out.println("<h2 align=\"center\">Resultado del retiro</h2>");
            out.println("<br>");
            out.println("<br>");
            out.println("<br>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RespRetiro.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
