...
//---------------------------------METODOS DE CLASE-------------------------------------------------  
    ...
    public static Persona insertarCliente(String apellido1,String apellido2, String nombre,
            int idCliente, LocalDate fechaNacimiento,int telefonoCliente, String correo) throws ClassNotFoundException
    {
    ...
    public static ArrayList<Persona> ordenarClientes() throws ClassNotFoundException{
      ...
      Collections.sort(personasSistema, new ComparatorApellido());
