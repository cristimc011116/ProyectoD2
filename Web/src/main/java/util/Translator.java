...
public class Translator {
  ...
  /**
    ...
    /**
           ...
           * @param targetLang idioma de destino. Debe ser un idioma de destino claro y eficaz
     * @return
     * @throws Exception
     */
    public String translateText(String text,String sourceLang, String targetLang) throws Exception{
        ...
        if( !( isSupport(sourceLang) || isSupport(targetLang) ) ){
            JOptionPane.showMessageDialog(null, "Tipo de idioma no admitido");           
        }
...
//        String finalPath=PATH +"?client="+CLIENT+"&sl="+sourceLang+"&tl="+targetLang+"&dt=t&q="+ text ;
        ...
        if( null == resp ){
            JOptionPane.showMessageDialog(null, "Excepción de red");             
        }
