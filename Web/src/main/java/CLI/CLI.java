...
public class CLI {
    ...
    public static double LlenarTablaConsultaBancoTotalizado(String cuenta) throws ClassNotFoundException
    {
      double sumaComisiones = 0;
    ...
    public static double LlenarTablaConsultaBancoPorCuenta(String cuenta) throws ClassNotFoundException
    {
      double sumaComisiones = 0;
      System.out.println("------------------------------------------------------------------------------------");
    ...
    public static int validarId() throws ClassNotFoundException
    {
        Scanner sc = new Scanner (System.in);
    ...
    public static void pedirInfoUsuario() throws ClassNotFoundException
    {
        Scanner sc = new Scanner (System.in);
    ...
    public static int pedirId() throws ClassNotFoundException
    {
        Scanner sc = new Scanner (System.in);
        String texto = "Digite su identificacion: ";
        System.out.println(texto);
    ...
    public static String pedirNumCuenta() throws ClassNotFoundException
    {
        Scanner sc = new Scanner (System.in);
    ...
    public static String consultarCliente(String idUsuario) throws ClassNotFoundException
    {
        ...
        public static String consultarCuenta(String pNumeroCuenta) throws ClassNotFoundException
    {
    ...
    public static String consultarUsuario(String idUsuario) throws ClassNotFoundException
    {
    ...
    public static void consultarStatus(String opcion) throws ClassNotFoundException
    {
        if("17".equals(opcion)){
            String pNumCuenta = pedirNumCuenta();
            Cuenta cuenta = CuentaDAO.obtenerCuenta(pNumCuenta);
        ...
        public static void consultarUnaCuenta(String opcion) throws ClassNotFoundException
    {
        if("18".equals(opcion)){
            String pNumCuenta = pedirNumCuenta();
